        ...
        <div className="w-full lg:w-3/5 space-y-6 text-center lg:text-left">
          ...
          <div className="pt-4 flex justify-center lg:justify-start">
            <a
              href="/cv.pdf"
              target="_blank"
              className="group relative inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-linear-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 transition-all duration-300 font-semibold shadow-lg shadow-red-600/30 hover:shadow-red-600/50 hover:scale-105 overflow-hidden"
            >
              <span className="relative z-10 flex items-center gap-2">
                📄 Download Resume
                <svg
              ...
              <span className="absolute inset-0 bg-linear-to-r from-white/20 to-transparent translate-x-full group-hover:translate-x-full transition-transform duration-700" />
            </a>
          </div>
        </div>
      </div>
